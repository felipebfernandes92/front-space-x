...
export default function Proximos (props: LaunchProps) {
  return (
    <div className={styles.container}>
      ...
      <main className="container">
        <Title>
          <h1 className="title">Próximos lançamentos</h1>
        </Title>
        <BoxLaunchs>
            {
                props.upcomingLaunches.map((launch: any, i: number) => {
                    return (<Launch key={i}>
                        <div className="info">
                        ...
                        <div className="launch">
                            ...
                            <Countdown date={launch.date}></Countdown>
                        </div>
                    </Launch>);
                })
            }    
...
export async function getServerSideProps() {
  const resUpcoming = await fetch('http://api-space-x.herokuapp.com/launches/upcoming')
